...
export const DB: ConditionsDB = {
  back: [
    ...
    // feat includes user-chip tokens ('bowel', 'bladder') so the bowel/bladder
    // symptom chip ("Difficulty in control of bowel or bladder or having
    // sexual dysfunction") matches via forward substring. Clinical tokens
    // ('urine control loss', 'erectile dysfunction') are retained for LLM
    // free-text extraction. Cauda Equina is the most time-critical MSK
    // emergency — it MUST surface whenever the user flags bowel/bladder.
    { name: 'Cauda Equina', flag: 'red', age: 'any', gender: 'both', feel: 'constant,intermittent', agg: ['loading', 'standing', 'walking', 'claudication'], rel: ['rest', 'sitting'], dur: 'chronic,acute', status: 'worsening', feat: ['weakness in lower legs', 'numbness', 'unable to walk', 'urine control loss', 'bowel', 'bladder', 'saddle anesthesia', 'erectile dysfunction', 'muscle paralysis'], neuro: 'affected' },
